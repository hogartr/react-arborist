...
export declare class TreeApi<T> {
    ...
    props: TreeProps<T>;
    list: MutableRefObject<VariableSizeList | null>;
    ...
    constructor(store: Store<RootState, Actions>, props: TreeProps<T>, list: MutableRefObject<VariableSizeList | null>, listEl: MutableRefObject<HTMLDivElement | null>);
    ...
    redrawList: (afterIndex?: number | undefined | null) => void;
