...
export type RowHeightCalculatorParams<T> = Pick<NodeApi<T>, "childIndex" | "children" | "data" | "parent" | "id" | "rowIndex" | "tree" | "isRoot" | "isLeaf" | "isClosed" | "isOpen" | "isAncestorOf" | "level">;
export type RowHeightCalculator<T> = (params: RowHeightCalculatorParams<T>) => number;
